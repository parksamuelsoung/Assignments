...
public class ArrayPractice {
	...
	public static void main(String[] args) {
		...
		System.out.printf("My list of favorite foods are:%n%s%n%s%n%s%n%n", 
				favoriteFoods[i++], favoriteFoods[i++], favoriteFoods[i++]);
		...
		System.out.printf("My updated list of favorite foods are:%n%s%n%s%n%s%n%n", 
				favoriteFoods[j++], favoriteFoods[j++], favoriteFoods[j++]);
		...
		System.out.printf("My new list of more favorite foods are:%n%s%n%s%n%s%n%s%n%s%n%n", 
				favoriteFoods[k++], favoriteFoods[k++], favoriteFoods[k++], favoriteFoods[k++], favoriteFoods[k++]);
